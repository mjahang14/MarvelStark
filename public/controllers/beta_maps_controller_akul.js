...
function route()
{
  ...
  "features": [
	...
	temp_route.features[0].geometry.coordinates.push([source_global.lng,source_global.lat]);
	temp_route.features[1].geometry.coordinates.push([dest_global.lng,dest_global.lat]);

	var xhr = new XMLHttpRequest();
	xhr.open('POST','/api/getRoute/',true);
	xhr.setRequestHeader("Content-Type","application/json; charset=UTF-8");
	xhr.send(JSON.stringify(temp_route));
	xhr.onreadystatechange = function()
	{
		if (xhr.readyState == XMLHttpRequest.DONE)
		{
